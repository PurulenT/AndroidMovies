...
//    @GET("v1.4/movie?token=FNE5FN8-B0KM23T-KBAA52K-G7G30Q8&selectFields=videos&selectFields=id&sortField=rating.kp&sortType=-1&limit=250")
    ...
    @GET("v1.5/review?token=FNE5FN8-B0KM23T-KBAA52K-G7G30Q8&selectFields=type&selectFields=createdAt&selectFields=title&selectFields=author&selectFields=review&limit=10")
